...
<h3>Sponsors</h3>
  ...
  <a href="https://cofound.it/" class="default"><img src="img/logo-cofoundit.png" alt="cofoundit logo" title="cofoundit logo" /></a>
    ...
    <div class="col-md-4 dark-text">
      ...
      <p>Current activities of LGBTIQ in Tech include meetups and informal mentorship program. Join our Facebook group to be included!</p>

      <h2>Values</h2>
      <p>In everything we organise, we follow our Code of Conduct.</p>

      <p>Screw ups happen. It’s everyone’s personal responsibility to get educated about inclusivity, but we can always give a reasonable amount of guidance and support to each other in these efforts.</p>

      <p>At the heart of our values are gender balance, acknowledging our respective privileges, and being mindful of taking up space.</p>
