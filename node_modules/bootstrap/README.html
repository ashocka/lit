...
<p><h3 align="center">Bootstrap</h3></p>
...
<li>Install with <a href="https://yarnpkg.com/">yarn</a>: <code>yarn add bootstrap@4.0.0</code></li>
<li>Install with <a href="https://getcomposer.org/">Composer</a>: <code>composer require twbs/bootstrap:4.0.0</code></li>
<li>Install with <a href="https://www.nuget.org/">NuGet</a>: CSS: <code>Install-Package bootstrap -Pre</code> Sass: <code>Install-Package bootstrap.sass -Pre</code> (<code>-Pre</code> is only required until Bootstrap v4 has a stable release).</li>
</ul>
...
<p>Documentation search is powered by <a href="https://community.algolia.com/docsearch/">Algolia&#8217;s DocSearch</a>. Working on our search? Be sure to set <code>debug: true</code> in the <code>_scripts.html</code> include.</p>

<h3 id="runningdocumentationlocally">Running documentation locally</h3>

<ol>
<li>Run through the <a href="https://getbootstrap.com/docs/4.0/getting-started/build-tools/#tooling-setup">tooling setup</a> to install Jekyll (the site builder) and other Ruby dependencies with <code>bundle install</code>.</li>
...
<h3 id="documentationforpreviousreleases">Documentation for previous releases</h3>
