...
<div class="row">
  ...
  <div class="credits col-sm-12 col-md-3">
    ...
    <p>Built with Bootstrap 4 and Entypo icons.</p>
  </div>
</div>
  ...
  <a href="https://cofound.it/" class="default"><img src="img/logo-cofoundit.png" alt="cofoundit logo" title="cofoundit logo" /></a>
    ...
    <div class="box col-md-12 wires dark-text box-events">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <a href="https://www.facebook.com/events/1419927251452463/" class="default"><div class="single-event get-together">
            <div>Workshop
...
<div class="box dark-text col-md-9 box-activities">
  ...
  <h2>Activities</h2>
  <p>We organise a number of events for the community. Most are taking place in Poligon coworking space in Ljubljana.</p>
  <ul>
    <li>
    ...
    <li>
      <a href="activities/co-working.html">1. co-working</a>
      <p>queer co-working in Ziferblat</p>
    </li>
    <li>
      <a href="activities/get-togethers.html">2. get-togethers</a>
      <p>connecting the community over drinks</p>
    </li>
    <li>
      <a href="activities/workshops.html">3. workshops</a>
